...
export default function EditDoctor(props) {
  ...
  return (
    <div>
        ...
        <div style={{ borderRadius: "10px", border: "solid black", padding: "50px" }}>

        <h2 style={{font: 'Poppins Arial sans-serif'}}>Edit Doctor</h2>
        ...
        <br></br>
            ...
            <button type="submit" onClick={handleSubmit} style={{backgroundColor:'#303c6c',color:'white'}} className="btn">Update</button>
