  ...
  return (
    <div>
        ...
        <br></br>
            ...
            <div className="form-group col-lg-6">
                <label htmlFor="name">Appointment_time</label>
                <input type="time" className="form-control" id="phone" name="appointment_time" value={input.appointment_time || ''} onChange={handleChange}  placeholder="Enter appointment date" />
            </div>
            <br/>
            <button type="submit" style={{ marginRight: "10px", backgroundColor: '#303c6c', color: '#fff' }} onClick={handleSubmit} className="btn">Submit</button>
        </div>
